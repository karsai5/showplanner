...
// GetEventsPreloaded provides a mock function with given fields: showId
func (_m *MockIDatabase) GetEventsPreloaded(showId uint) ([]Event, error) {
	ret := _m.Called(showId)

	if len(ret) == 0 {
		panic("no return value specified for GetEventsPreloaded")
	}
...
// MockIDatabase_GetEventsPreloaded_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetEventsPreloaded'
type MockIDatabase_GetEventsPreloaded_Call struct {
	*mock.Call
}

// GetEventsPreloaded is a helper method to define mock.On call
//   - showId uint
func (_e *MockIDatabase_Expecter) GetEventsPreloaded(showId interface{}) *MockIDatabase_GetEventsPreloaded_Call {
	return &MockIDatabase_GetEventsPreloaded_Call{Call: _e.mock.On("GetEventsPreloaded", showId)}
}

func (_c *MockIDatabase_GetEventsPreloaded_Call) Run(run func(showId uint)) *MockIDatabase_GetEventsPreloaded_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(uint))
	})
	return _c
...
func (_c *MockIDatabase_GetEventsPreloaded_Call) Return(_a0 []Event, _a1 error) *MockIDatabase_GetEventsPreloaded_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockIDatabase_GetEventsPreloaded_Call) RunAndReturn(run func(uint) ([]Event, error)) *MockIDatabase_GetEventsPreloaded_Call {
	_c.Call.Return(run)
	return _c
}
