...
// PostRolesParams contains all the bound params for the post roles operation
// typically these are obtained from a http.Request
//
// swagger:parameters PostRoles
...
//
// To ensure default values, the struct must have been initialized with NewPostRolesParams() beforehand.
