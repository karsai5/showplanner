...
// UpdateShowreportDTO update showreport d t o
//
// swagger:model updateShowreportDTO
type UpdateShowreportDTO struct {
...
// Validate validates this update showreport d t o
func (m *UpdateShowreportDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateShowreportDTO) validateActOneFOHClearance(formats strfmt.Registry) error {
...
func (m *UpdateShowreportDTO) validateActTwoFOHClearance(formats strfmt.Registry) error {
...
func (m *UpdateShowreportDTO) validateHouseOpen(formats strfmt.Registry) error {
...
func (m *UpdateShowreportDTO) validateIntervalEnd(formats strfmt.Registry) error {
...
func (m *UpdateShowreportDTO) validateIntervalStart(formats strfmt.Registry) error {
...
func (m *UpdateShowreportDTO) validateShowEnd(formats strfmt.Registry) error {
...
func (m *UpdateShowreportDTO) validateShowStart(formats strfmt.Registry) error {
...
// ContextValidate validates this update showreport d t o based on context it is used
func (m *UpdateShowreportDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *UpdateShowreportDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UpdateShowreportDTO) UnmarshalBinary(b []byte) error {
	var res UpdateShowreportDTO
