...
var postMeHandler = operations.PostMeHandlerFunc(func(params operations.PostMeParams) middleware.Responder {
...
var getMeHandler = operations.GetMeHandlerFunc(func(params operations.GetMeParams) middleware.Responder {
	userId, err := permissions.GetUserId(params.HTTPRequest)
	if err != nil {
