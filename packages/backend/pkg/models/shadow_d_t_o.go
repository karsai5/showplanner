...
// ShadowDTO shadow d t o
//
// swagger:model shadowDTO
...
// Validate validates this shadow d t o
func (m *ShadowDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ShadowDTO) validatePerson(formats strfmt.Registry) error {
...
// ContextValidate validate this shadow d t o based on the context it is used
func (m *ShadowDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ShadowDTO) contextValidatePerson(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ShadowDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ShadowDTO) UnmarshalBinary(b []byte) error {
	var res ShadowDTO
