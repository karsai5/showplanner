...
func (m *ShowDTO) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 BaseShowDTO
...
func (m ShowDTO) MarshalJSON() ([]byte, error) {
	_parts := make([][]byte, 0, 1)

	aO0, err := swag.WriteJSON(m.BaseShowDTO)
	if err != nil {
		return nil, err
	}
...
func (m *ShowDTO) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with BaseShowDTO
	if err := m.BaseShowDTO.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ShowDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	// validation for a type composition with BaseShowDTO
	if err := m.BaseShowDTO.ContextValidate(ctx, formats); err != nil {
		res = append(res, err)
	}
