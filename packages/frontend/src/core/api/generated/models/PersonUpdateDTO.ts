...
export function PersonUpdateDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): PersonUpdateDTO {
    ...
    return {
        ...
        'hearAboutUs': !exists(json, 'hearAboutUs') ? undefined : json['hearAboutUs'],
        'previousWork': !exists(json, 'previousWork') ? undefined : json['previousWork'],
        'reasonForCrewing': !exists(json, 'reasonForCrewing') ? undefined : json['reasonForCrewing'],
    };
}
...
export function PersonUpdateDTOToJSON(value?: PersonUpdateDTO | null): any {
    ...
    return {
        ...
        'reasonForCrewing': value.reasonForCrewing,
    };
}
