 ...
 * 
 * @export
 * @interface UpdateShowTimerDTO
 */
export interface UpdateShowTimerDTO {
    /**
     * 
     * @type {Date}
     * @memberof UpdateShowTimerDTO
     */
...
/**
 * Check if a given object implements the UpdateShowTimerDTO interface.
 */
export function instanceOfUpdateShowTimerDTO(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UpdateShowTimerDTOFromJSON(json: any): UpdateShowTimerDTO {
    return UpdateShowTimerDTOFromJSONTyped(json, false);
}

export function UpdateShowTimerDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateShowTimerDTO {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'expectedCurtainsUp': !exists(json, 'expectedCurtainsUp') ? undefined : (json['expectedCurtainsUp'] === null ? null : new Date(json['expectedCurtainsUp'])),
...
export function UpdateShowTimerDTOToJSON(value?: UpdateShowTimerDTO | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'expectedCurtainsUp': value.expectedCurtainsUp === undefined ? undefined : (value.expectedCurtainsUp === null ? null : value.expectedCurtainsUp.toISOString()),
