...
export function AvailabilitiesDTOEventsInnerFromJSON(
  json: any
): AvailabilitiesDTOEventsInner {
  return AvailabilitiesDTOEventsInnerFromJSONTyped(json, false);
}

export function AvailabilitiesDTOEventsInnerFromJSONTyped(
  json: any,
...
export function AvailabilitiesDTOEventsInnerToJSON(
  value?: AvailabilitiesDTOEventsInner | null
): any {
  if (value === undefined) {
    return undefined;
  }
