...
export function PublicScheduleGet200ResponseFromJSON(json: any): PublicScheduleGet200Response {
    return PublicScheduleGet200ResponseFromJSONTyped(json, false);
}

export function PublicScheduleGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicScheduleGet200Response {
    ...
    return {
        ...
        'events': !exists(json, 'events') ? undefined : ((json['events'] as Array<any>).map(EventPublicDTOFromJSON)),
    };
}

export function PublicScheduleGet200ResponseToJSON(value?: PublicScheduleGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'events': value.events === undefined ? undefined : ((value.events as Array<any>).map(EventPublicDTOToJSON)),
    };
}
