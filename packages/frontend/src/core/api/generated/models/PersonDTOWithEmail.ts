...
export function PersonDTOWithEmailFromJSONTyped(
  json: any,
  ...
  return {
    ...
    _private: !exists(json, "private")
      ? undefined
      : PersonPrivateDetailsDTOFromJSON(json["private"]),
    email: !exists(json, "email") ? undefined : json["email"],
  };
}

export function PersonDTOWithEmailToJSON(
  value?: PersonDTOWithEmail | null
): any {
  if (value === undefined) {
    return undefined;
  }
