 ...
 */
export function instanceOfPersonSummaryDTOPrivateEmergencyContact(
  value: object
): boolean {
  let isInstance = true;
...
export function PersonSummaryDTOPrivateEmergencyContactFromJSON(
  json: any
): PersonSummaryDTOPrivateEmergencyContact {
  return PersonSummaryDTOPrivateEmergencyContactFromJSONTyped(json, false);
}

export function PersonSummaryDTOPrivateEmergencyContactFromJSONTyped(
  json: any,
...
export function PersonSummaryDTOPrivateEmergencyContactToJSON(
  value?: PersonSummaryDTOPrivateEmergencyContact | null
): any {
  if (value === undefined) {
    return undefined;
  }
