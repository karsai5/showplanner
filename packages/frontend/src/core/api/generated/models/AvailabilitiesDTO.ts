...
export function AvailabilitiesDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): AvailabilitiesDTO {
    ...
    return {
        ...
        'events': !exists(json, 'events') ? undefined : ((json['events'] as Array<any>).map(AvailabilitiesDTOEventsInnerFromJSON)),
    };
}
...
export function AvailabilitiesDTOToJSON(value?: AvailabilitiesDTO | null): any {
    ...
    return {
        ...
        'events': value.events === undefined ? undefined : ((value.events as Array<any>).map(AvailabilitiesDTOEventsInnerToJSON)),
    };
}
