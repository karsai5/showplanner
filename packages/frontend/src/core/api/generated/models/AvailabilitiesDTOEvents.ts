...
export function AvailabilitiesDTOEventsFromJSON(json: any): AvailabilitiesDTOEvents {
    return AvailabilitiesDTOEventsFromJSONTyped(json, false);
}

export function AvailabilitiesDTOEventsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AvailabilitiesDTOEvents {
...
export function AvailabilitiesDTOEventsToJSON(value?: AvailabilitiesDTOEvents | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
