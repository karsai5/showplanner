...
export function RosterDTOFromJSONTyped(
  ...
  return {
    roles: !exists(json, "roles")
      ? undefined
      : (json["roles"] as Array<any>).map(RoleDTOFromJSON),
    events: !exists(json, "events")
      ? undefined
      : (json["events"] as Array<any>).map(RosterDTOEventsInnerFromJSON),
  };
}
  ...
  return {
    roles:
      value.roles === undefined
        ? undefined
        : (value.roles as Array<any>).map(RoleDTOToJSON),
    events:
      value.events === undefined
        ? undefined
        : (value.events as Array<any>).map(RosterDTOEventsInnerToJSON),
  };
}
