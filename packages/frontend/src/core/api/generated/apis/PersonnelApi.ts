...
export class PersonnelApi extends runtime.BaseAPI {
  ...
  async meDetailsGet(
    ...
    const response = await this.meDetailsGetRaw(initOverrides);
  ...
  async personnelPeopleGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<PersonDTOWithEmail>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(PersonDTOWithEmailFromJSON)
    );
  }
  ...
  async personnelPeopleGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<PersonDTOWithEmail>> {
   ...
   */
  async personnelPeoplePersonIdGetRaw(
    requestParameters: PersonnelPeoplePersonIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PersonDTO>> {
    if (
      ...
      throw new runtime.RequiredError(
        "personId",
        "Required parameter requestParameters.personId was null or undefined when calling personnelPeoplePersonIdGet."
      );
    }
    ...
    const response = await this.request(
      {
        path: `/personnel/people/{personId}`.replace(
          `{${"personId"}}`,
   ...
   * Get details of person
   */
  async personnelPeoplePersonIdGet(
    requestParameters: PersonnelPeoplePersonIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PersonDTO> {
    const response = await this.personnelPeoplePersonIdGetRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
