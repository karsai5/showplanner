...
export class DefaultApi extends runtime.BaseAPI {
    ...
    /**
     */
    async impersonatePostRaw(requestParameters: ImpersonatePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.userId === null || requestParameters.userId === undefined) {
            throw new runtime.RequiredError('userId','Required parameter requestParameters.userId was null or undefined when calling impersonatePost.');
        }
    ...
    /**
     */
    async impersonatePost(requestParameters: ImpersonatePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     */
    async invitationsGetRaw(requestParameters: InvitationsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<InvitationDTO>>> {
        if (requestParameters.showId === null || requestParameters.showId === undefined) {
            throw new runtime.RequiredError('showId','Required parameter requestParameters.showId was null or undefined when calling invitationsGet.');
        }
     ...
     * Get invitations for a show
     */
    async invitationsGet(requestParameters: InvitationsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<InvitationDTO>> {
     ...
     * Returns all people
     */
    async personnelGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ArrayOfPersonSummaryDTO>> {
        const queryParameters: any = {};
     ...
     * Returns all people
     */
    async personnelGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ArrayOfPersonSummaryDTO> {
     ...
     */
    async showreportsGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ShowReportSummaryDTO>>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(ShowReportSummaryDTOFromJSON));
    }

    /**
     * Get users show reports
     */
    async showreportsGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<ShowReportSummaryDTO>> {
     ...
     * Adds a person to a show
     */
    async showreportsIdGetRaw(requestParameters: ShowreportsIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShowReportDTO>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling showreportsIdGet.');
        }
        ...
        const response = await this.request({
            path: `/showreports/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ShowReportDTOFromJSON(jsonValue));
    }

    /**
     * Adds a person to a show
     */
    async showreportsIdGet(requestParameters: ShowreportsIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShowReportDTO> {
        const response = await this.showreportsIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async showreportsIdPdfGetRaw(requestParameters: ShowreportsIdPdfGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling showreportsIdPdfGet.');
        }
        ...
        const response = await this.request({
            path: `/showreports/{id}/pdf`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Returns the report in the PDF format
     */
    async showreportsIdPdfGet(requestParameters: ShowreportsIdPdfGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Blob> {
        const response = await this.showreportsIdPdfGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Adds a person to a show
     */
    async showreportsIdPostRaw(requestParameters: ShowreportsIdPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShowReportDTO>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling showreportsIdPost.');
        }
     ...
     * Adds a person to a show
     */
    async showreportsIdPost(requestParameters: ShowreportsIdPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShowReportDTO> {
        const response = await this.showreportsIdPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async showreportsIdTexGetRaw(requestParameters: ShowreportsIdTexGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShowreportsIdTexGet200Response>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling showreportsIdTexGet.');
        }
        ...
        const response = await this.request({
            path: `/showreports/{id}/tex`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ShowreportsIdTexGet200ResponseFromJSON(jsonValue));
    }

    /**
     * Returns the report in the TEX format
     */
    async showreportsIdTexGet(requestParameters: ShowreportsIdTexGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShowreportsIdTexGet200Response> {
        const response = await this.showreportsIdTexGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Get users show reports
     */
    async showtimersGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ShowTimerSummaryDTO>>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(ShowTimerSummaryDTOFromJSON));
    }

    /**
     * Get users show reports
     */
    async showtimersGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<ShowTimerSummaryDTO>> {
     ...
     * Adds a person to a show
     */
    async showtimersIdGetRaw(requestParameters: ShowtimersIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShowTimerDTO>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling showtimersIdGet.');
        }
        ...
        const response = await this.request({
            path: `/showtimers/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ShowTimerDTOFromJSON(jsonValue));
    }

    /**
     * Adds a person to a show
     */
    async showtimersIdGet(requestParameters: ShowtimersIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShowTimerDTO> {
        const response = await this.showtimersIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Adds a person to a show
     */
    async showtimersIdPostRaw(requestParameters: ShowtimersIdPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShowTimerDTO>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling showtimersIdPost.');
        }
     ...
     * Adds a person to a show
     */
    async showtimersIdPost(requestParameters: ShowtimersIdPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShowTimerDTO> {
        const response = await this.showtimersIdPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
