...
export class DefaultApi extends runtime.BaseAPI {
  ...
  async personnelGetRaw(
    requestParameters: PersonnelGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "showId",
        "Required parameter requestParameters.showId was null or undefined when calling personnelGet."
      );
    }
  ...
  async personnelGet(
    ...
    const response = await this.personnelGetRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
