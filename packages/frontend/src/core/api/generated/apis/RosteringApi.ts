...
export class RosteringApi extends runtime.BaseAPI {
   ...
   */
  async showsShowIdPeopleUnassignPostRaw(
    requestParameters: ShowsShowIdPeopleUnassignPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (
      requestParameters.showId === null ||
      ...
      throw new runtime.RequiredError(
        "showId",
        "Required parameter requestParameters.showId was null or undefined when calling showsShowIdPeopleUnassignPost."
      );
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "personId",
        "Required parameter requestParameters.personId was null or undefined when calling showsShowIdPeopleUnassignPost."
      );
    }
    ...
    const response = await this.request(
      {
        path: `/shows/{showId}/people/unassign`.replace(
          `{${"showId"}}`,
          encodeURIComponent(String(requestParameters.showId))
        ),
        method: "POST",
   ...
   * Unassign a person from a show
   */
  async showsShowIdPeopleUnassignPost(
    requestParameters: ShowsShowIdPeopleUnassignPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
   ...
   */
  async showsShowIdRolesSetorderPostRaw(
    requestParameters: ShowsShowIdRolesSetorderPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (
      requestParameters.showId === null ||
      ...
      throw new runtime.RequiredError(
        "showId",
        "Required parameter requestParameters.showId was null or undefined when calling showsShowIdRolesSetorderPost."
      );
    }
    ...
    const response = await this.request(
      {
        path: `/shows/{showId}/roles/setorder`.replace(
          `{${"showId"}}`,
          encodeURIComponent(String(requestParameters.showId))
        ),
        method: "POST",
   ...
   * Set the order of the roles for a show
   */
  async showsShowIdRolesSetorderPost(
    requestParameters: ShowsShowIdRolesSetorderPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.showsShowIdRolesSetorderPostRaw(
      requestParameters,
      initOverrides
    );
  }
