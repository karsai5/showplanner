  ...
  return <SessionAuth>
    <div className="prose">
      ...
      <ol className="list-decimal">
        <li>On your computer, open <Link href="https://calendar.google.com/calendar"> Google Calendar.</Link></li>
        <li>On the left, next to &quot;Other calendars,&quot; click <code>+</code> then <code>From URL</code>.</li>
        <li>Enter this address: <code>{calendarUrl}</code></li>
      ...
      <ol className="list-decimal">
        ...
        <li>In Calendar, choose <code>File</code> &gt; <code>New Calendar Subscription</code></li>
        <li>Enter this address: <code>{calendarUrl}</code>, then click Subscribe.</li>
        <li>Enter a name for the calendar and choose a color to help you identify it on your calendar.</li>
